...
namespace BangazonSite.Controllers
{
    ...
    //    }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateCreated,Description,Title,Price,Quantity,UserId,City,ProductImage,LocalDelivery,ProductTypeId,Archived")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
